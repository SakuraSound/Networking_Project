...
public class CommTests {
    ...
    public void test_read_list_marshal() throws InvalidRecordException, JAXBException{
        ...
        ReadListMessage msg = ReadListMessage.create_message(record_list, 0);
        ReadListMessage test_msg = (ReadListMessage) CommUtilities.bytes_2_java(msg.to_bytes(), ReadListMessage.class);
